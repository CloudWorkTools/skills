...
The repository workflow runs weekly on Monday at 03:17 UTC and supports manual dispatch. Its GitHub Actions job summary contains the report; a content change produces a warning, and a check failure fails the job. GitHub can delay scheduled runs or disable schedules in inactive repositories. The CLI remains available independently. This workflow does not create issues or automatically merge changes.
